...
let commitButton = document.getElementById("commit-progress");
let commitTimeLabel = document.getElementById("commit-time");
let filteredCommits = commits;

function onTimeSliderChange() {
    commitProgress = commitButton.value;
    commitMaxTime = timeScale.invert(commitProgress);
    commitTimeLabel.innerHTML = commitMaxTime.toLocaleString();
...
onTimeSliderChange();
commitButton.addEventListener('input', onTimeSliderChange);
